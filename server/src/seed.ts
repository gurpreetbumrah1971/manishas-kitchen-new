...
const menuItems: MenuItemSeed[] = [
  ...
  { name: 'Chicken Galouti Kebab', description: 'Tender minced chicken kebab with aromatic spices.', price: 195, categoryName: 'Kebabs', isVeg: false, image: photoUpdateUrl('chicken-kheema-paratha') },
  { name: 'Chicken Shami Kebab', description: 'Spiced chicken and lentil kebab cooked until tender.', price: 195, categoryName: 'Kebabs', isVeg: false, image: photoUpdateUrl('chicken-kheema-paratha') },

...
async function main() {
  ...
  await prisma.foodItem.createMany({
    data: [
      // Snacks
      { name: 'Poha', description: 'Flattened rice seasoned with spices.', price: 30, categoryId: snacks.id, isVeg: true, image: '/food/poha.png' },
      { name: 'Poha Usal', description: 'Poha served with spicy bean curry.', price: 40, categoryId: snacks.id, isVeg: true, image: '/food/poha.png' },
      ...
      { name: 'Dhokla (Half)', description: 'Steamed gram flour cake (4 pieces).', price: 40, categoryId: snacks.id, isVeg: true, image: '/food/dhokla.jpeg' },
      { name: 'Dhokla (Full)', description: 'Steamed gram flour cake (8 pieces).', price: 70, categoryId: snacks.id, isVeg: true, image: '/food/dhokla.jpeg' },
      ...
      // Meals
      { name: 'Misal Pav', description: 'Spicy sprout curry topped with farsan, served with pav.', price: 80, categoryId: meals.id, isVeg: true, image: '/food/misal-pav.png' },
      ...
      { name: 'Chole Puri', description: 'Spicy chickpeas served with 4 fluffy fried puris.', price: 110, categoryId: meals.id, isVeg: true, image: '/food/chole-puri.png' },
      { name: 'Chole Bhature', description: 'Spicy chickpeas served with 2 large bhaturas.', price: 150, categoryId: meals.id, isVeg: true, image: '/food/chole-puri.png' },
      { name: 'Chole Plate', description: 'A plate of spicy chickpeas (Chole only).', price: 80, categoryId: meals.id, isVeg: true, image: '/food/chole-puri.png' },
      { name: 'Puri Plate', description: 'A plate of 4 fluffy fried puris.', price: 40, categoryId: meals.id, isVeg: true, image: '/food/chole-puri.png' },
      { name: 'Bhatura', description: 'Single large fluffy fried bread.', price: 40, categoryId: meals.id, isVeg: true, image: '/food/chole-puri.png' },
      ...
      // Beverages
      { name: 'Tea', description: 'Hot traditional Indian masala chai.', price: 15, categoryId: beverages.id, isVeg: true, image: '/food/tea.png' },
      ...
      { name: 'Lemon Tea', description: 'Refreshing hot lemon tea.', price: 25, categoryId: beverages.id, isVeg: true, image: '/food/lemon-tea.png' },
      ...
      { name: 'Iced Tea', description: 'Chilled lemon infused iced tea.', price: 40, categoryId: beverages.id, isVeg: true, image: '/food/iced-tea.png' },

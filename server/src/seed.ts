...
const menuItems: MenuItemSeed[] = [
  ...
  { name: 'Aloo Frankie', description: 'Soft roll filled with spiced potato and chutney.', price: 79, categoryName: 'Frankies', isVeg: true, image: generatedMenuAssetUrl('Aloo Frankie') },
  { name: 'Paneer Frankie', description: 'Soft roll filled with spiced paneer and onions.', price: 139, categoryName: 'Frankies', isVeg: true, image: generatedMenuAssetUrl('Paneer Frankie') },
  { name: 'Chicken Frankie', description: 'Soft roll filled with spiced chicken and onions.', price: 139, categoryName: 'Frankies', isVeg: false, image: photoUpdateUrl('chicken-kheema-paratha') },

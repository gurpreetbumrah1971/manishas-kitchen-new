...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section style={{
        height: '60vh',
        background: 'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&q=80&w=1200") no-repeat center/cover',
        display: 'flex',
